...
parser.add_argument('--folder', type=str, default = "./", help = "Folder to store all the preprocessed data")
...
np.save(args.folder+'char_indices.npy', char_indices)
np.save(args.folder+'indices_char.npy', indices_char)
...
np.save(args.folder+'char_embedding_matrix.npy', embedding_matrix)
# ===============================================
...
with open(args.folder+'tokenizer.pickle', 'wb') as handle:
...
np.save(args.folder+'word_embedding_matrix.npy', word_embed_matrix)
