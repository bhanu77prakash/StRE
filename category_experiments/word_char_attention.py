# ======================================================================
# =           Code to run the word+character+attention model           =
# ======================================================================
...
# =======================================================================================
# =           Character LSTM , Word LSTM, attention for both and dense layers           =
# =======================================================================================
...
model = Model(inputs = [sentence_input, word_input], outputs = out5)
...
model.fit([X_train, word_train], Y_train, batch_size=batch_size, epochs=epochs,  validation_data=[[X_vali, word_vali], V_test], verbose=0)
model.save(args.save_folder+filename.strip().split("/")[-1].split(".")[0]+'_epochs_'+str(epochs)+'.h5')
