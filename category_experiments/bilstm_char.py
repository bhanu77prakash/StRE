# =================================================================================
# =           Code that runs the character model described in the paper           =
# =================================================================================
...
# Dense layers
out1 = Dense(16, activation='relu')(char_att)
...
model = Model(inputs = sentence_input, outputs = out5)
...
model.fit(X_train, Y_train, batch_size=batch_size, epochs=epochs,  validation_data=[X_vali, V_test], verbose=0)
