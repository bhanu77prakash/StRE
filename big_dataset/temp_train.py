...
parser.add_argument('--folder', type=str, default = "./", help = "Folder containing all the preprocessed data")
...
model.save('model_'+filename.strip().split("/")[-1].split(".")[0]+'_epochs_'+str(epochs)+'.h5')
...
# fpr, tpr, thresholds = metrics.roc_curve(Y_test, predicts, pos_label=1)
...
# np.save(args.folder+args.file+'_test_dict.npy', test_dict) 